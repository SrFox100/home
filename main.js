var texts = ["Hello.", "Hello one...", "Hi.!?", "Hello again!", "...", "Hello my friend!", "Æ my friend.", "Привет.", "Привет снова!", "Хеллоу май визитор.", "Hello there...", "Hello kind sir!", "Hello and so on.", "Hi what what?", "Hey what's up?", "Mustæ!", "И уже не исколечить, смех площённый дураков, ведь запрыгнул ей на плечи, мокрый ангел с облаков...", "こんにちは私の親愛なる友人。", "안녕하세요.", "Willst du bis der Tod euch scheidet, treu ihrsein für alle Tage.", "Mister bombastic, bomba fantasta.", "中國公民你好。", "Æԙ.", '<span style="color: red;">This text is red.</span>'];
